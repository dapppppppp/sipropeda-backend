...
func (r *usulanProyekRepository) ResolveAll() ([]UsulanProyek, error) {
	...
	query := `
		SELECT u.id, u.tahun_anggaran, u.bidang_id, b.nama_bidang as bidang_name, u.nama_proyek, u.lokasi, u.volume, u.satuan, u.nilai_rab, u.status_sifat, u.status_tahapan, u.sumber_dana_id, s.nama_sumber as sumber_dana_name, u.created_at, u.updated_at 
