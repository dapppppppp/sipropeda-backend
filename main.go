...
func main() {
	...
	// -- Domain Auth (Role) <-- Didaftarkan di sini
	...
	menuRepo := auth.ProvideMenuRepository(dbConn)
	menuSvc := auth.ProvideMenuService(menuRepo)
	...
	domainHandlers := router.DomainHandlers{
		...
		AuthHandler:     authHdl,
		RoleHandler:     roleHdl, // <-- Masukkan Role Handler
		SumberDanaHandler: sumberDanaHdl, // <-- Masukkan ke sini
		PaguAnggaranHandler: paguAnggaranHdl, // <-- Masuk sini
		UsulanProyekHandler: usulanProyekHdl, // <-- Masukkan Usulan Proyek Handler
		PenilaianUsulanHandler: penilaianHdl, // <-- Masukkan Penilaian Usulan Handler
		PerankinganHandler: perankinganHdl, // <-- Masukkan Perankingan Handler
		MenuHandler: menuHdl, // <-- Masukkan Menu Handler
	}
